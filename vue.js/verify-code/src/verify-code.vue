<template>
  <div class="vcWrap">
    <input v-for="n in 4" :key="'codeInput' + n" 
    v-model.number="code[n-1]" :ref="'codeInput' + n" @keydown="onkeydown(n)" @keyup="onkeyup(n)">
  </div>
</template>
...
export default {
  ...
  data () {
    return {
      ...
      keyCode: [
        48,49,50,51,52,53,54,55,56,56,57,96,97,98,99,100,101,102,103,104,105,13,8
      ]
    }
  },
  methods: {
